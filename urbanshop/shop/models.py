...
class Product(models.Model):
    ...
    Categories = models.ManyToManyField(to=Category, related_name = 'category')
...
class Sale(models.Model):
    product = models.OneToOneField(to = Product, to_field = 'id', on_delete = models.CASCADE, null = True)
    price = models.IntegerField(blank = False)
...
class Order(models.Model):
    created_by = models.ManyToOneRel(to = Customer, field = models.ForeignKey, field_name = 'customer')
...
class OrderItem(models.Model):
    order = models.ManyToOneRel(to = Order, field = models.ForeignKey, field_name = 'order')
    product = models.OneToOneRel(to = Product, field = models.ForeignKey, field_name = 'product')
    quantity = models.IntegerField(blank = False)
    unit_price = models.IntegerField(blank = False)
    shipping_date = models.DateTimeField(blank = False)

class Transaction(models.Model):
    order = models.OneToOneRel(to = Order, field = models.ForeignKey, field_name = 'order')
...
class CartItem(models.Model):
    cart = models.ManyToOneRel(to = Cart, field = models.ForeignKey, field_name = 'cart')
    product = models.OneToOneRel(to = Product, field = models.ForeignKey, field_name = 'product')
    quantity = models.IntegerField(blank = False)
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField()
